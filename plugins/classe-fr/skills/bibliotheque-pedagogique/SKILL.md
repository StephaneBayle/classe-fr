...
Lire `references/sources-et-droits.md`, `references/matrice-couverture-discipline-niveau.md` et `references/confidentialite.md` avant tout traitement.
...
5. Proposer une fiche de réemploi : pour quel objectif, sous quelle forme, avec quelles alternatives de représentation ou d'expression.
