...
class ClasseFrTests(unittest.TestCase):
    ...
    def test_page_publique_est_presente_et_reference_des_images_locales(self):
        ...
        self.assertIn("Je débute avec Classe FR", page)
        self.assertIn("Vous préférez qu'il vous guide", page)
        self.assertIn("Dites-lui que vous débutez", page)
        self.assertIn("Vous pouvez refuser : tout fonctionne sans.", page)
